...
const toolbarItems: Array<{
  ...
  { command: "h2", label: "H2", icon: <Heading2 size={22} /> },
  { command: "h3", label: "H3", icon: <Heading3 size={22} /> },
  { command: "bold", label: "粗体", icon: <Bold size={22} /> },
  { command: "italic", label: "斜体", icon: <Italic size={22} /> },
  { command: "quote", label: "引用", icon: <Quote size={22} /> },
  { command: "inline-code", label: "代码", icon: <Code size={22} /> },
  { command: "code-block", label: "代码块", icon: <FileCode2 size={22} /> },
  { command: "bulleted-list", label: "列表", icon: <List size={22} /> },
  { command: "todo-list", label: "待办", icon: <ListTodo size={22} /> },
  { command: "link", label: "链接", icon: <Link2 size={22} /> },
];
    ...
    <div className={containerClasses}>
      ...
      {props.onTogglePreview && (
        ...
        >
          ...
          >
            {props.isPreviewOpen ? <EyeOff size={22} /> : <Eye size={22} />}
