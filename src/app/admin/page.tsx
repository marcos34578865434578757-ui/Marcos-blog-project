    ...
    <>
      ...
      <main className="mx-auto w-full max-w-6xl px-5 py-10">
        <section className="soft-panel p-7">
          ...
          <p className="mt-3 max-w-2xl leading-7 text-muted">草稿保存在 Vercel Blob，点击发布时才写入 GitHub 并触发部署。</p>
        </section>
        ...
        <section className="mt-6 grid gap-4 md:grid-cols-3">
          <AdminAction href="/admin/posts" icon={<FileText size={20} />} title="管理文章" body="查看 Blob 草稿与仓库中已发布的文章。" />
          <AdminAction href="/admin/posts/new" icon={<PenLine size={20} />} title="新建草稿" body="用 Markdown 写一篇新文章。" />
